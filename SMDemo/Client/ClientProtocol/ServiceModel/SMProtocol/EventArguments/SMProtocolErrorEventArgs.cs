//-----------------------------------------------------------------------
// <copyright file="SMProtocolErrorEventArgs.cs" company="Microsoft Open Technologies, Inc.">
//
// ---------------------------------------
// HTTPbis
...
namespace System.ServiceModel.SMProtocol
{
    ...
    /// </summary>
    public class SMProtocolErrorEventArgs : EventArgs
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SMProtocolErrorEventArgs"/> class.
        /// </summary>
        /// <param name="exeption">The error source exeption.</param>
        public SMProtocolErrorEventArgs(Exception exeption)
        {
            this.Exeption = exeption;
        }

        /// <summary>
        /// Gets or sets the source exeption.
        /// </summary>
        /// <value>
        /// The exeption.
        /// </value>
