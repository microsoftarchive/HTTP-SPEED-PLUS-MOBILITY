//-----------------------------------------------------------------------
// <copyright file="StreamInfo.cs" company="Microsoft Open Technologies, Inc.">
//
// ---------------------------------------
// HTTPbis
...
{
    /// <summary>
    ///  struct to keep Upstream/downstream byte count
    /// </summary>
    public struct StreamInfo
    {
        ...
        /// <summary>
        /// Gets or sets upstream byte count.
        /// </summary>
        public int UpCount { get; set; }

        /// <summary>
        /// Gets or sets downstream byte count
        /// </summary>
...
/*
        ...
        {
            int total = this.DownCount + this.UpCount;
            return "Bytes transferred:" + this.UpCount + " upstream, " +
                this.DownCount + " downstream, " +
                total + " Total";
        }
